...
type
  IAbastecimento = interface
    ...
    function CalcularImposto(const AValor, APercImposto: Double): Double;
    function CalcularQtdLitros(const AValor, APrecoLitro: Double): Double;
    function CalcularValorTotal(const AQtdLitros, APrecoLitro: Double): Double;
  end;
...
function TAbastecimento.CalcularImposto(const AValor,
  APercImposto: Double): Double;
begin
  Result := AValor * (APercImposto / 100);
end;

function TAbastecimento.CalcularQtdLitros(const AValor,
  APrecoLitro: Double): Double;
begin
  Result := AValor / APrecoLitro;
end;

function TAbastecimento.CalcularValorTotal(const AQtdLitros,
  APrecoLitro: Double): Double;
begin
  Result := APrecoLitro * AQtdLitros;
end;
